...
Along a similar line of reasoning, we can consider the complement of $A$. Note that the complement of $A$ is the union of two intervals, and is therefore not closed (only finite sets and all of $\mathbb{R}$ are closed under this topology), which implies that $A$ is not open.
\end{proof}
\end{answer}
\pagebreak
\end{document}